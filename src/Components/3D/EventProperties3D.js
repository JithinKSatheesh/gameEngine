...
export default function EventProperties3D() {
    return (
        <div className="GameEventProperties m-2 radius-1">
            ...
            <div  className="p-4">
                <ProductConsumer>
                    { values => (
                        <>
                            <RenderForm initialvalues={values.selectedEntity} />
                        </>
                ...
                {(values)=>{
                    ...
                    return(
                        ...
                        <div className="row GameObjectPhysicsPropertiesBox">
                            ...
                            <div className="col-6 p-1">{values.selectedEntity.id}</div>
                            {/* ========================== */}
